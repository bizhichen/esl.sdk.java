...
public class SigningLogoConverterTest implements ConverterTest {
    ...
    public void convertSDKToSDK() {
        ...
        assertThat( "Converter didn't return the same non-null sdk object it was given", result.getImage(), is( "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEUAAABnCA" ) );
    }
    ...
    public void convertAPIToAPI() {
        ...
        assertThat( "image was not set correctly", result.getImage(), is( "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEUAAABnCA" ) );
    }
